...
export const DEFAULT_APPS: AppEntry[] = [
  ...
  },
  {
    id: "loom",
    name: "Loom",
    description: "Personlig idé-arkiv · AI-canvas + incubator",
    icon: "🧶",
    kind: "web",
    localUrl: "http://localhost:5173/",
    tailscaleUrl: `http://${TAILSCALE_IP}:5173/`,
    healthUrl: "http://localhost:5173/",
  },
  {
    id: "sonarr",
    name: "Sonarr",
    description: "TV-serie download · monitored library",
    icon: "📺",
    kind: "external",
    localUrl: "http://localhost:8989/",
    tailscaleUrl: `http://${TAILSCALE_IP}:8989/`,
  },
  {
    id: "radarr",
    name: "Radarr",
    description: "Film download · monitored library",
    icon: "🎬",
    kind: "external",
    localUrl: "http://localhost:7878/",
    tailscaleUrl: `http://${TAILSCALE_IP}:7878/`,
  },
  {
    id: "heimdall",
    name: "Heimdall",
