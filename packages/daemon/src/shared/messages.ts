...
export const StashListRequestSchema = z.object({
  ...
  cwd: z.string(),
  /** If true, only return skynet-created stashes. Default true. */
  skynetOnly: z.boolean().optional(),
  requestId: z.string(),
});
...
export const SkynetWorktreeListRequestSchema = z.object({
  type: z.literal("skynet_worktree_list_request"),
  cwd: z.string().optional(),
  repoRoot: z.string().optional(),
  requestId: z.string(),
});

export const SkynetWorktreeArchiveRequestSchema = z.object({
  type: z.literal("skynet_worktree_archive_request"),
...
export const CreateSkynetWorktreeRequestSchema = z.object({
  type: z.literal("create_skynet_worktree_request"),
  cwd: z.string(),
  worktreeSlug: z.string().optional(),
  attachments: AgentAttachmentsSchema,
  refName: z.string().min(1).optional(),
...
export const SessionInboundMessageSchema = z.discriminatedUnion("type", [
  ...
  SkynetWorktreeListRequestSchema,
  SkynetWorktreeArchiveRequestSchema,
  CreateSkynetWorktreeRequestSchema,
...
export const ProjectCheckoutLiteNotGitPayloadSchema = z
  .object({
    ...
    isSkynetOwnedWorktree: z.literal(false),
    mainRepoRoot: z.null(),
  })
  .transform((value) => ({
    ...value,
...
export const ProjectCheckoutLiteGitNonSkynetPayloadSchema = z
  .object({
    cwd: z.string(),
...
export const ProjectCheckoutLiteGitSkynetPayloadSchema = z
  .object({
    cwd: z.string(),
    isGit: z.literal(true),
    currentBranch: z.string().nullable(),
    remoteUrl: z.string().nullable(),
    worktreeRoot: z.string().optional(),
    isSkynetOwnedWorktree: z.literal(true),
...
export const ProjectCheckoutLitePayloadSchema = z.union([
  ...
  ProjectCheckoutLiteGitNonSkynetPayloadSchema,
  ProjectCheckoutLiteGitSkynetPayloadSchema,
]);
...
const WorkspaceGitRuntimePayloadSchema = z
  .object({
    ...
    isSkynetOwnedWorktree: z.boolean().optional(),
...
const CheckoutStatusGitNonSkynetSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isSkynetOwnedWorktree: z.literal(false),
  repoRoot: z.string(),
  currentBranch: z.string().nullable(),
...
const CheckoutStatusGitSkynetSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isSkynetOwnedWorktree: z.literal(true),
  repoRoot: z.string(),
  mainRepoRoot: z.string(),
...
export const CheckoutStatusResponseSchema = z.object({
  ...
  payload: z.union([
    ...
    CheckoutStatusGitNonSkynetSchema,
    CheckoutStatusGitSkynetSchema,
  ]),
});
...
const SkynetWorktreeSchema = z.object({
  worktreePath: z.string(),
  createdAt: z.string(),
...
export const SkynetWorktreeListResponseSchema = z.object({
  type: z.literal("skynet_worktree_list_response"),
  payload: z.object({
    worktrees: z.array(SkynetWorktreeSchema),
    error: CheckoutErrorSchema.nullable(),
    requestId: z.string(),
  }),
});

export const SkynetWorktreeArchiveResponseSchema = z.object({
  type: z.literal("skynet_worktree_archive_response"),
  payload: z.object({
    success: z.boolean(),
...
export const CreateSkynetWorktreeResponseSchema = z.object({
  type: z.literal("create_skynet_worktree_response"),
  payload: z.object({
    workspace: WorkspaceDescriptorPayloadSchema.nullable(),
    error: z.string().nullable(),
    errorCode: z.string().optional(),
...
export const SessionOutboundMessageSchema = z.discriminatedUnion("type", [
  ...
  SkynetWorktreeListResponseSchema,
  SkynetWorktreeArchiveResponseSchema,
  CreateSkynetWorktreeResponseSchema,
...
export type CreateSkynetWorktreeRequest = z.infer<typeof CreateSkynetWorktreeRequestSchema>;
...
export type SkynetWorktreeListRequest = z.infer<typeof SkynetWorktreeListRequestSchema>;
export type SkynetWorktreeListResponse = z.infer<typeof SkynetWorktreeListResponseSchema>;
export type SkynetWorktreeArchiveRequest = z.infer<typeof SkynetWorktreeArchiveRequestSchema>;
export type SkynetWorktreeArchiveResponse = z.infer<typeof SkynetWorktreeArchiveResponseSchema>;
