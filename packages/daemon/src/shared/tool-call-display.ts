...
import { getSkynetToolLeafName, isSkynetToolName } from "../server/agent/tool-name-normalization.js";
...
function humanizeToolName(name: string): string {
  ...
  if (isSkynetToolName(trimmed)) {
    const leaf = getSkynetToolLeafName(trimmed);
    if (leaf) {
