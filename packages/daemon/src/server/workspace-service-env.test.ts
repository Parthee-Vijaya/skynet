...
describe("buildWorkspaceServiceEnv", () => {
  ...
  it("builds default branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      SKYNET_PORT: "5173",
      SKYNET_URL: "http://daemon.skynet.localhost:6767",
      SKYNET_SERVICE_DAEMON_PORT: "5173",
      SKYNET_SERVICE_DAEMON_URL: "http://daemon.skynet.localhost:6767",
    });
  });
  ...
  it("builds feature branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      SKYNET_PORT: "5173",
      SKYNET_URL: "http://daemon.feature-x.skynet.localhost:6767",
      SKYNET_SERVICE_DAEMON_PORT: "5173",
      SKYNET_SERVICE_DAEMON_URL: "http://daemon.feature-x.skynet.localhost:6767",
    });
  });

  it("omits PORT while keeping SKYNET_PORT", () => {
    ...
    expect(env.SKYNET_PORT).toBe("5173");
  ...
  it("adds peer service ports and URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      SKYNET_PORT: "5173",
      SKYNET_URL: "http://web.feature-x.skynet.localhost:6767",
      SKYNET_SERVICE_API_PORT: "4000",
      SKYNET_SERVICE_API_URL: "http://api.feature-x.skynet.localhost:6767",
      SKYNET_SERVICE_WEB_PORT: "5173",
      SKYNET_SERVICE_WEB_URL: "http://web.feature-x.skynet.localhost:6767",
    });
  });
