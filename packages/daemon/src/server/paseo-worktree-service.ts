...
export interface CreateSkynetWorktreeInput extends CreateWorktreeCoreInput {}

export interface CreateSkynetWorktreeResult {
...
export type CreateSkynetWorktreeFn = (
...
export interface CreateSkynetWorktreeDeps extends CreateWorktreeCoreDeps {
  projectRegistry: Pick<ProjectRegistry, "get" | "upsert">;
  workspaceRegistry: Pick<WorkspaceRegistry, "get" | "list" | "upsert">;
  workspaceGitService: WorkspaceGitService;
}

export async function createSkynetWorktree(
  input: CreateSkynetWorktreeInput,
  deps: CreateSkynetWorktreeDeps,
): Promise<CreateSkynetWorktreeResult> {
...
async function upsertWorkspaceForWorktree(options: {
  ...
  repoRoot: string;
  worktree: WorktreeConfig;
  deps: Pick<CreateSkynetWorktreeDeps, "projectRegistry" | "workspaceRegistry">;
