 ...
 *   SKYNET_LISTEN=127.0.0.1:7777 npx tsx packages/server/src/server/daemon-e2e/checkout-debug.ts
 */
...
const SKYNET_HOME = process.env.SKYNET_HOME ?? `${os.homedir()}/.skynet`;
const SKYNET_LISTEN = process.env.SKYNET_LISTEN ?? "127.0.0.1:6767";
const DAEMON_URL = `ws://${SKYNET_LISTEN}/ws`;
...
async function main() {
  ...
  console.log("==================================================");
  console.log(`SKYNET_HOME: ${SKYNET_HOME}`);
