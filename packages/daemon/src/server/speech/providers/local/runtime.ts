...
import type { SkynetSpeechConfig } from "../../../bootstrap.js";
...
function buildModelDownloadHint(modelId: LocalSpeechModelId): string {
  return `Use 'skynet speech download --model ${modelId}' to download this model.`;
}

function resolveConfiguredLocalModels(speechConfig: SkynetSpeechConfig | null): ResolvedLocalModels {
  return {
...
export function getLocalSpeechAvailability(
  speechConfig: SkynetSpeechConfig | null,
