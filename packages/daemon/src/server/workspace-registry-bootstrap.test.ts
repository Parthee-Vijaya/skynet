...
describe("bootstrapWorkspaceRegistries", () => {
  ...
  beforeEach(() => {
    ...
    skynetHome = path.join(tmpDir, ".skynet");
    agentStorage = new AgentStorage(path.join(skynetHome, "agents"), logger);
    projectRegistry = new FileBackedProjectRegistry(
      path.join(skynetHome, "projects", "projects.json"),
      logger,
    );
    workspaceRegistry = new FileBackedWorkspaceRegistry(
      path.join(skynetHome, "projects", "workspaces.json"),
      logger,
    );
