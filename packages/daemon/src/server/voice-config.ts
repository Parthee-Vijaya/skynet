const VOICE_PROMPT_BLOCK_START = "<skynet_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</skynet_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Skynet voice mode is now on.",
  "You are the Skynet voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Skynet voice mode is now off.",
  "Ignore any earlier Skynet voice mode instructions in this thread.",
].join(" ");
