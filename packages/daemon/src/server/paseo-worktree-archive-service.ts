...
import { deleteSkynetWorktree, resolveSkynetWorktreeRootForCwd } from "../utils/worktree.js";
import type { TerminalManager } from "../terminal/terminal-manager.js";

type EmitSessionMessage = (message: SessionOutboundMessage) => void;

export type ArchiveSkynetWorktreeDependencies = {
  skynetHome?: string;
...
export async function archiveSkynetWorktree(
  dependencies: ArchiveSkynetWorktreeDependencies,
  options: {
    targetPath: string;
  ...
  const resolvedWorktree = await resolveSkynetWorktreeRootForCwd(targetPath, {
