...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("/tmp/skynet.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("unix:///tmp/skynet.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("pipe://\\\\.\\pipe\\skynet-managed-test"), null);
  assert.strictEqual(resolveTcpHostFromListen("\\\\.\\pipe\\skynet-managed-test"), null);
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("C:\\Users\\foo\\.skynet\\skynet.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("D:\\project\\socket"), null);
  assert.strictEqual(resolveTcpHostFromListen("C:\\skynet.sock"), null);
