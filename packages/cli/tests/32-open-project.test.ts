...
const existingProject = join(await mkdtemp(join(tmpdir(), "skynet-open-project-")), "project");
...
const previousDesktopCli = process.env.SKYNET_DESKTOP_CLI;
process.env.SKYNET_DESKTOP_CLI = "1";
...
process.env.SKYNET_DESKTOP_CLI = previousDesktopCli;
