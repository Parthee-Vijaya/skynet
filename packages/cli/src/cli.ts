...
export function createCli(): Command {
  ...
  program
    .name("skynet")
    .description("Skynet CLI - control your AI coding agents from the command line")
  ...
  addJsonOption(
    program
      .command("status")
      .description('Show local daemon status (alias for "skynet daemon status")'),
  )
  ...
  addJsonOption(
    program
      .command("restart")
      .description('Restart local daemon (alias for "skynet daemon restart")'),
  )
    .option("--home <path>", "Skynet home directory (default: ~/.skynet)")
